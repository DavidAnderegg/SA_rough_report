...
processors, i.e takes care of the parallelization; and part (2) that does the
actual computation. This allows tapenade to differentiate the math heavy part
and necessitates the developer to make sure the differentiated routines are
